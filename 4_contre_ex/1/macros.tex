...
\newcommand{\f}{\rw}
\newcommand{\aaex}{{\it A}_{\R}}
\newcommand{\aaexeq}{{\it A}_{\R,E}}
...
%\newcommand{\none}{\kw{none}}
\newcommand{\true}{\mathbbm{t}rue}
\newcommand{\false}{\mathbbm{f}alse}
